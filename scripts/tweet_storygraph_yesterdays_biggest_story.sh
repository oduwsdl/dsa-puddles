...
sumgrams=`cat /Users/smj/Unsynced-Projects/dsa-puddles-working/storygraph-biggest-stories/completed-dates/${post_date}/sumgram_data.tsv | awk -F'\t' '{ print $1 }' | head -n 6 | tail -n 5 | tr '\n' ',' | sed 's/,$//g' | sed 's/,/, /g'`
